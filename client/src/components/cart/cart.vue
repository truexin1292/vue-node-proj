    ...
    <div class="s-cart">
        <div class="cart-cont">
            <ul>
                <li class="cont-one" v-for="(cart, index) in carts">
                    <input class="goods-checkbox" type="checkbox" v-model="cart.cart_isSelect"
                           @click="clickSelect(cart)">
        ...
        <div class="cart-counter">
            <div class="all-checkbox">
                <input type="checkbox" name="all-goods" class="all-goods" v-model="isAllSelectState"
